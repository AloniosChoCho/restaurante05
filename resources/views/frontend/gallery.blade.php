        ...
        <div class="webkit-and-moz-overlay-background">
            <div class="container">
                <div class="center-section">
                    <h2 class="section-title-border whiteTitleBorder">Galería</h2>
...
<section class="gallery-content">
        <div class="container">
            <h2 class="section-title-border edit-padding0">De nuestro chef</h2>
            ...
            <div id="gallery-box" class="row edit-paddingTop40">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="xp-grid-thumb">
                            <img class="gallery-slide-image" src="{{ asset ('frontend/assets/images/gallery/4.jpg') }} " data-src="{{ asset ('frontend/assets/images/gallery/4.jpg') }} " title="Pasta de buena comida" alt="Pescado frito con salsa" />
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="xp-grid-thumb">
                            <img class="gallery-slide-image" src="{{ asset ('frontend/assets/images/gallery/5.jpg') }} " data-src="{{ asset ('frontend/assets/images/gallery/5.jpg') }} " title="Pasta de buena comida" alt="Pescado frito con salsa" />
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="xp-grid-thumb">
                            <img class="gallery-slide-image" src="{{ asset ('frontend/assets/images/gallery/6.jpg') }} " data-src="{{ asset ('frontend/assets/images/gallery/6.jpg') }} " title="Pasta de buena comida" alt="Pescado frito con salsa" />
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="xp-grid-thumb">
                            <img class="gallery-slide-image" src="{{ asset ('frontend/assets/images/gallery/7.jpg') }} " data-src="{{ asset ('frontend/assets/images/gallery/7.jpg') }} " title="Pasta de buena comida" alt="Pescado frito con salsa" />
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="xp-grid-thumb">
                            <img class="gallery-slide-image" src="{{ asset ('frontend/assets/images/gallery/8.jpg') }} " data-src="{{ asset ('frontend/assets/images/gallery/8.jpg') }} " title="Pasta de buena comida" alt="Pescado frito con salsa" />
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="xp-grid-thumb">
                            <img class="gallery-slide-image" src="{{ asset ('frontend/assets/images/gallery/9.jpg') }} " data-src="{{ asset ('frontend/assets/images/gallery/9.jpg') }} " title="Pasta de buena comida" alt="Pescado frito con salsa" />
                    </div>
                </div>
            </div>
        </div>
