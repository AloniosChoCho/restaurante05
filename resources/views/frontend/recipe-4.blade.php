            ...
            <div class="flex-row row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="item-box">
                        ...
                        <div class="item-main-section">
                            <div class="item-img">
                                <div class="view-image" data-image-src="{{ asset ('frontend/assets/images/content/09_food500x400.jpg') }} "></div>
                            </div>
                            <div class="main-desc">
                                <h3 class="item-title">Su nombre de la receta</h3>
                                <div class="description">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="item-box">
                        ...
                        <div class="item-main-section">
                            <div class="item-img">
                                <div class="view-image" data-image-src="{{ asset ('frontend/assets/images/content/10_food500x400.jpg') }} "></div>
                            </div>
                            <div class="main-desc">
                                <h3 class="item-title">Su nombre de la receta</h3>
                                <div class="description">
