                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                  ...
                                  @endif
                                  <form action="{{ route('contact.update', ['contact' => $contact->id]) }}" class="row" method="POST">
                                    @method('PUT')
                                    @csrf
                                    ...
                                    <div class="form-group col-sm-12">
                                      ...
                                      <textarea class="form-control textarea" id="description" name="description">{{$contact->description}}</textarea>
                                    </div>
                                    <div class="col-sm-12 mt-3">
                                      <a href="{{ route('contact.index') }}" class="btn btn-sm btn-danger">Cancelar</a>
