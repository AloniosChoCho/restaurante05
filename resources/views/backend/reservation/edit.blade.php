            ...
            <div class="col-sm-12 col-md-6">
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="{{ url('page-reservation-update') }}" method="POST">
                    @csrf
                    <input type="hidden" name="id" value="{{$reservation->id}}">
                    <div class="col-sm-12 col-md-12 mb-3">
                      <div class="form-group">
                        <label for="">Título</label>
                        <input type="text" class="form-control" name="title" value="{{$reservation->header_title}}">
                      </div>
                      <div class="form-group">
                        <label for="">Descripción</label>
                        <textarea class="form-control textarea" name="description" row="3">{{$reservation->header_description}}</textarea>
                      </div>
                    </div>
