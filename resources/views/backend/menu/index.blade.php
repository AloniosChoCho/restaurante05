                      ...
                      <div class="card-body">
                        ...
                        <div class="col-sm-12 col-md-12 mb-3">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{$menu->header_title ?? ''}}" readonly>
                          </div>
                          <div class="form-group">
                            <label for="">Descripción</label>
                            <textarea class="form-control textarea" readonly row="3">{{$menu->header_description ?? ''}}</textarea>
                          </div>
                        </div>
                        <div class="col-sm-12 text-right mb-3">
                          <a href="{{ url("page-menu-edit?id=$menu->id") }}" class="btn btn-primary"><i class="far fa-edit"></i> Editar</a>
                        </div>
